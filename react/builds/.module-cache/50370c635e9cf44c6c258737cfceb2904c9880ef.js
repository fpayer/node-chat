(function(window) {
  var Sidebar = React.createClass({displayName: "Sidebar",
    ...
    setName : function() {
      console.log($(React.findDOMNode(this.refs.name)).val());
      this.props.stream.emit('name', $(React.findDOMNode(this.refs.name)).val());
    },
    setRoom : function() {
      this.props.stream.emit('room', $(React.findDOMNode(this.refs.room)).val());
    },
    render : function() {
                ...
                React.createElement("div", {className: "ui form", ref: "infoForm"}, 
                  React.createElement("div", {className: "two fields"}, 
                    React.createElement("div", {className: "field"}, 
                      ...
                      React.createElement("input", {type: "text", name: "name", defaultValue: this.props.name, onBlur: this.setName})
                    ), 
                    React.createElement("div", {className: "field"}, 
                      React.createElement("label", null, "Chatroom"), 
                      React.createElement("input", {type: "text", name: "room", defaultValue: this.props.room, onBlur: this.setRoom})
                    )
                  ), 
                  React.createElement("div", {className: "field"}, 
