(function(window) {
  ...
  var App = React.createClass({displayName: "App",
    ...
    loadSettings : function() {
      ...
      window.name = $(React.findDOMNode(this.refs.name));
      window.room = $(React.findDOMNode(this.refs.room));
    ...
    render : function() {
      return React.createElement("div", null, 
        ...
        React.createElement(Component.Sidebar, {name: this.state.name, room: this.state.room}), 
