            ...
            React.createElement("tr", null, 
              React.createElement("td", null, 
                React.createElement("div", {className: "ui fluid input"}, 
                  React.createElement("form", {id: "dropzone", className: "dropzone", style: "border:1px solid rgba(0,0,0,0.03); min-height:240px; -webkit-border-radius: 3px; border-radius:3px; background: rgba(0,0,0,0.03); padding: 23px; position: relative; cursor:pointer", action: "/upload/"}, 
