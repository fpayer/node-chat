...
//          errorMessage : 
    ...
    render : function() {
      return React.createElement("div", {style: _={height:'100%',display:'none'}, id: "editor"}, 
        ...
        React.createElement("div", {style: _={position:'absolute',bottom:'25px',right:'100px'}}, 
          React.createElement("i", {className: 'ui big icon ' + (!this.state.error ? 'green check circle' : 'red minus circle')})
        ), 
